        ...
        <div className="border-t border-white/10 bg-clay-primary px-4 py-4 text-white md:hidden">
          <div className="mx-auto flex max-w-7xl flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 pt-2">
              {!user && (
                <Link to="/login" className="inline-flex items-center justify-center rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white">
                  Sign In
                </Link>
              )}
              <Link to={cta.to} className="inline-flex items-center justify-center rounded-full bg-clay-accent px-4 py-2 text-sm font-semibold text-clay-primary">
                {cta.label}
              </Link>
            </div>
          </div>
